...
const steps = [
    {
        ...
        desc: "We start by understanding your challenge, goals, and technical requirements.",
        icon: <SearchIcon className="text-[#0BA57F] text-4xl animate-float drop-shadow-[0_0_6px_#0BA57F66]" />
    },
    {
        id: 2,
        title: "Scope & Roadmap",
        desc: "Define clear deliverables, timelines, and technical architecture.",
        icon: <TimelineIcon className="text-[#0BA57F] text-4xl animate-float drop-shadow-[0_0_6px_#0BA57F66]" />
    },
    {
        id: 3,
        title: "Build & Iterate",
        desc: "Rapid development cycles with continuous feedback and refinement.",
        icon: <ConstructionIcon className="text-[#0BA57F] text-4xl animate-float drop-shadow-[0_0_6px_#0BA57F66]" />
    },
    {
        id: 4,
        title: "Deploy & Support",
        desc: "Ship to production with deployment support and handoff documentation.",
...
const HowWeWork = () => {
    return (
        <section id="how-we-work" className="relative bg-[#0B0B0B] text-white py-16 px-6 md:px-16 overflow-hidden">
