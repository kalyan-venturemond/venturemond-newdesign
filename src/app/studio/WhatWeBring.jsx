...
const whatWeBring = [
    "Full-stack product development (design, engineering, deployment)",
    "Market validation and user research expertise",
    "Product strategy and roadmap planning",
    "Go-to-market execution and growth frameworks",
    "Technical infrastructure built to scale",
    "Founder-level commitment to your success"
];
    ...
    return (
        <section className="bg-[#0B0B0B] text-white py-16 px-6 md:px-16">
            <div className="max-w-5xl mx-auto text-center space-y-8">
                ...
                >
                    We're not just builders — we're co-founders who care about outcomes.
                </motion.p>
            </div>
        </section>
    );
